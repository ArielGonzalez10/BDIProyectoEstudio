...
--Obtener los datos de los huesped como administrador
EXECUTE AS USER = 'Administrador';
SELECT * FROM Huesped;
REVERT;
...
--Insertar un huesped como usuario
EXECUTE AS USER = 'Usuario';
EXECUTE sp_insertar_huesped 
			@dni = 41679183,
			@nombre = 'Enzo',
			@apellido = 'Barrios', 
			@fecha_nacimiento = '2004-03-10';
REVERT;
--Resultado de la ejecución (usuario): Fallo, no tiene los permisos para insertar datos